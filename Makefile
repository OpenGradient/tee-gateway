...
help:
	...
	@echo ""
	@echo "Testing from the enclave host (no payment required, loopback only):"
	@echo "  make test-chat HOST=http://127.0.0.1:8000"
	@echo "  make test-chat-all-models HOST=http://127.0.0.1:8000"
	@echo "  Note: port 8000 is bound to 127.0.0.1 only and bypasses x402 for 127.0.0.1."
	@echo "  External clients via port 443 always go through the payment gate."
