...
from openapi_server.models.fine_tuning_integration import FineTuningIntegration  # noqa: E501
...
class FineTuningJob(Model):
    ...
    def __init__(self, id=None, created_at=None, error=None, fine_tuned_model=None, finished_at=None, hyperparameters=None, model=None, object=None, organization_id=None, result_files=None, status=None, trained_tokens=None, training_file=None, validation_file=None, integrations=None, seed=None, estimated_finish=None, method=None):  # noqa: E501
        ...
        :type integrations: List[FineTuningIntegration]
    ...
    @property
    def integrations(self) -> List[FineTuningIntegration]:
        ...
        :rtype: List[FineTuningIntegration]
        """
        return self._integrations

    @integrations.setter
    def integrations(self, integrations: List[FineTuningIntegration]):
