...
from openapi_server.models.create_chat_completion_request_audio import CreateChatCompletionRequestAudio  # noqa: E501
from openapi_server.models.create_chat_completion_request_function_call import CreateChatCompletionRequestFunctionCall  # noqa: E501
from openapi_server.models.create_chat_completion_request_model import CreateChatCompletionRequestModel  # noqa: E501
from openapi_server.models.create_chat_completion_request_response_format import CreateChatCompletionRequestResponseFormat  # noqa: E501
from openapi_server.models.create_chat_completion_request_stop import CreateChatCompletionRequestStop  # noqa: E501
...
class CreateChatCompletionRequest(Model):
    ...
    def reasoning_effort(self) -> str:
        ...
        **o1 models only**   Constrains effort on reasoning for  [reasoning models](https://platform.openai.com/docs/guides/reasoning). Currently supported values are `low`, `medium`, and `high`. Reducing reasoning effort can result in faster responses and fewer tokens used on reasoning in a response.   # noqa: E501
    ...
    def metadata(self) -> Dict[str, str]:
        ...
        Developer-defined tags and values used for filtering completions in the [dashboard](https://platform.openai.com/chat-completions).   # noqa: E501
    ...
    def modalities(self) -> List[str]:
        ...
        Output types that you would like the model to generate for this request. Most models are capable of generating text, which is the default:  `[\"text\"]`  The `gpt-4o-audio-preview` model can also be used to [generate audio](/docs/guides/audio). To request that this model generate both text and audio responses, you can use:  `[\"text\", \"audio\"]`   # noqa: E501
    ...
    @property
    def audio(self) -> CreateChatCompletionRequestAudio:
    ...
    @audio.setter
    def audio(self, audio: CreateChatCompletionRequestAudio):
